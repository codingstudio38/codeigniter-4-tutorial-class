...
<?php endif ; ?>
<?php if(session()->getFlashdata('deleteProfile') != null) : ?>
<div class="alert alert-danger"><?php echo session()->getFlashdata('deleteProfile') ?></div>
<?php endif ; ?>
                </div>
                ...
                <form id="login_form" name="login_form" method="post" action="login">
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" name="email" id="email" class="form-control" placeholder="Username/Email Id" value="<?=old('email') ?>"/>
                  </div>
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <a  href="<?= base_url(); ?>/register" class="btn btn-outline-danger">Create new</a>
                  </div>
