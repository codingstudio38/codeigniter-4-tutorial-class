        ...
        <div class="col-md-8">
            <table width="60%" align="right">
                <tr>
                    ...
                    <td>
                        <a href="pdfview" class="btn btn-success"><i class="fa fa-arrow-circle-down"
                    ...
                    <td>
                        <a href="xlfiledownload" class="btn btn-primary"><i class="fa fa-arrow-circle-down"
                                aria-hidden="true"></i></a>
                    </td>
                </tr>
            </table>
...
{ ?>
                        <tr scope="row">
                            <td>
                                <a class="btn btn-danger" style="padding: 0.3rem 0.6rem;"
                                    href="daletedata/<?= $row['id']; ?>"><i class="fa fa-trash-o"
                                        aria-hidden="true"></i></a>
                                <a class="btn btn-success" style="padding: 0.3rem 0.6rem;"
                                    href="editdata/<?= $row['id']; ?>"><i class="fa fa-pencil-square-o"
                                        aria-hidden="true"></i></a>
                            </td>
                            <td><?= $i++; ?></td>
                            <td><?= $row['id']; ?></td>
                            ...
                            <td><img src="<?php echo base_url('/uploads/images/'.$row['thumbnail']);?>" width="30"
                                    height="30"></td>
            ...
            <div class="card border-success mb-3">
                <div class="card-header bg-transparent border-success"
                    style="background-color: #ebffe5 !important; text-align: center;">
                    <h2>UPLOAD</h2>
                </div>

                <div class="card-body text-success">
                    <form id="asfds" action="<?= base_url().'/modelInsert'; ?>" method="POST"
            ...
            <div class="card border-warning mb-3">
                <div class="card-header bg-transparent border-warning"
                    style="background-color: #fff9d3 !important; text-align: center;">
                    <h2>EXCEL UPLOAD</h2>
                </div>
                ...
                <div class="card-body text-success">
                    ...
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <?php $errors = session()->getFlashdata('error_msg'); echo $errors['fileimport']; ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
            ...
            <div class="card border-primary mb-3">
                <div class="card-header bg-transparent border-primary"
                    style="background-color: #d4e9fa !important; text-align: center;">
                ...
                <div class="card-body text-primary">
                    ...
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong>Status</strong>
                        <?php $errors = session()->getFlashdata('proFileerror'); echo $errors['profileimport']; ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
