...
<!-- Mirrored from eduport.webestica.com/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Dec 2021 04:52:29 GMT -->

<head>
	<title>Codeigniter 4-<?= $title; ?></title> 
					...
					<div class="col-lg-5 col-xl-6 text-center position-relative">
						...
						<div class="p-3 card card-body shadow rounded-4 position-absolute top-0 start-0 translate-middle ms-5 z-index-1 d-none d-xl-block">
							<div class="d-flex justify-content-between">
								<!-- Avatar -->
								<div class="avatar">
									<img class="avatar-img rounded-circle shadow" src="<?= base_url(); ?>/assets/images/avatar/04.jpg" alt="avatar">
								</div>
								<!-- Info -->
						...
						<div class=" position-relative">
							...
							<!-- Image -->
							<img src="<?= base_url(); ?>/assets/images/element/06.png" class="position-absolute bottom-0 start-50 translate-middle-x" alt="">
						</div>
								...
								<div class="tiny-slider-inner" data-autoplay="true" data-gutter="80" data-arrow="true" data-dots="false" data-items="5" data-items-lg="3" data-items-md="2" data-items-xs="1">
									...
									<div>
										<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
											<img src="<?= base_url(); ?>/assets/images/element/22.svg" class="h-40px" alt="">
									...
									<div>
										<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
											<img src="<?= base_url(); ?>/assets/images/element/23.svg" class="h-40px" alt="">
									...
									<div>
										<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
											<img src="<?= base_url(); ?>/assets/images/element/21.svg" class="h-40px" alt="">
									...
									<div>
										<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
											<img src="<?= base_url(); ?>/assets/images/element/24.svg" class="h-40px" alt="">
									...
									<div>
										<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
											<img src="<?= base_url(); ?>/assets/images/element/25.svg" class="h-40px" alt="">
									...
									<div>
										<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
											<img src="<?= base_url(); ?>/assets/images/element/26.svg" class="h-40px" alt="">
				...
				<div class="row g-4">
					...
					<div class="col-md-6 col-xl-4">
						<div class="card shadow-hover overflow-hidden bg-transparent">
							<div class="position-relative">
								<!-- Image -->
								<img class="card-img-top" src="<?= base_url(); ?>/assets/images/courses/4by3/16.jpg" alt="Card image">
								<!-- Overlay -->
									...
									<div class="w-100 mt-auto d-inline-flex">
										<div class="d-flex align-items-center bg-white p-2 rounded-2">
											...
											<div class="avatar avatar-sm me-2">
												<img class="avatar-img rounded-1" src="<?= base_url(); ?>/assets/images/avatar/10.jpg" alt="avatar">
											</div>
											<!-- Avatar info -->
											<div>
					...
					<div class="col-md-6 col-xl-4">
						<div class="card shadow-hover overflow-hidden bg-transparent">
							<div class="position-relative">
								<!-- Image -->
								<img class="card-img-top" src="<?= base_url(); ?>/assets/images/courses/4by3/14.jpg" alt="Card image">
								<!-- Overlay -->
								<div class="bg-overlay bg-dark opacity-4"></div>
								<div class="card-img-overlay d-flex align-items-start flex-column">
									<!-- Card overlay bottom -->
									<div class="w-100 mt-auto d-inline-flex">
										<div class="d-flex align-items-center bg-white p-2 rounded-2">
											<!-- Avatar -->
											<div class="avatar avatar-sm me-2">
												<img class="avatar-img rounded-1" src="<?= base_url(); ?>/assets/images/avatar/08.jpg" alt="avatar">
											</div>
											<!-- Avatar info -->
											<div>
					...
					<div class="col-md-6 col-xl-4">
						<div class="card shadow-hover overflow-hidden bg-transparent">
							<div class="position-relative">
								<!-- Image -->
								<img class="card-img-top" src="<?= base_url(); ?>/assets/images/courses/4by3/21.jpg" alt="Card image">
								<!-- Overlay -->
								<div class="bg-overlay bg-dark opacity-4"></div>
								<div class="card-img-overlay d-flex align-items-start flex-column">
									<!-- Card overlay bottom -->
									<div class="w-100 mt-auto d-inline-flex">
										<div class="d-flex align-items-center bg-white p-2 rounded-2">
											<!-- Avatar -->
											<div class="avatar avatar-sm me-2">
												<img class="avatar-img rounded-1" src="<?= base_url(); ?>/assets/images/avatar/05.jpg" alt="avatar">
											</div>
											<!-- Avatar info -->
											<div>
									...
									<div class="col-lg-6 position-relative">
										...
										<div class="tab-content mb-0 pb-0" id="course-pills-tabContent1">
											...
											<div class="tab-pane fade show active" id="course-pills-tab01" role="tabpanel" aria-labelledby="course-pills-tab-01">
												...
												<div class="card p-2 pb-0 shadow">
													<div class="overflow-hidden h-xl-200px">
														<img src="<?= base_url(); ?>/assets/images/about/13.jpg" class="card-img-top" alt="course image">
											...
											<div class="tab-pane fade" id="course-pills-tab02" role="tabpanel" aria-labelledby="course-pills-tab-02">
												...
												<div class="card p-2 pb-0 shadow">
													<div class="overflow-hidden h-xl-200px">
														<img src="<?= base_url(); ?>/assets/images/about/11.jpg" class="card-img-top" alt="course image">
														<div class="card-img-overlay d-flex p-3">
															<!-- Video button and link -->
															<div class="m-auto">
																<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
											...
											<div class="tab-pane fade" id="course-pills-tab03" role="tabpanel" aria-labelledby="course-pills-tab-03">
												...
												<div class="card p-2 shadow">
													<div class="overflow-hidden h-xl-200px">
														<img src="<?= base_url(); ?>/assets/images/about/14.jpg" class="card-img-top" alt="course image">
														<div class="card-img-overlay d-flex p-3">
															<!-- Video button and link -->
															<div class="m-auto">
																<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
							...
							<div class="col-lg-6">
								...
								<div class="card p-2 shadow">
									<div class="overflow-hidden rounded-3 h-xl-200px">
										<img src="<?= base_url(); ?>/assets/images/about/15.jpg" class="card-img rounded-3" alt="course image">
										<div class="card-img-overlay d-flex p-3">
											<!-- Video button and link -->
											<div class="m-auto">
												<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
					...
					<div class="tab-pane fade" id="course-pills-tab4" role="tabpanel" aria-labelledby="course-pills-tab-4">
						<div class="row g-4">
							...
							<div class="col-lg-6">
								...
								<div class="card p-2 shadow">
									<div class="overflow-hidden rounded-3 h-xl-200px">
										<img src="<?= base_url(); ?>/assets/images/about/12.jpg" class="card-img rounded-3" alt="course image">
										<div class="card-img-overlay d-flex p-3">
											<!-- Video button and link -->
											<div class="m-auto">
												<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
					...
					<div class="tab-pane fade" id="course-pills-tab5" role="tabpanel" aria-labelledby="course-pills-tab-5">
						<div class="row g-4">
							...
							<div class="col-lg-6">
								...
								<div class="card p-2 shadow">
									<div class="overflow-hidden rounded-3 h-xl-200px">
										<img src="<?= base_url(); ?>/assets/images/about/11.jpg" class="card-img rounded-3" alt="course image">
										<div class="card-img-overlay d-flex p-3">
											<!-- Video button and link -->
											<div class="m-auto">
												<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
					...
					<div class="tiny-slider arrow-round arrow-creative arrow-blur">
						<div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-dots="false" data-items="4" data-items-lg="3" data-items-md="2" data-items-xs="1">
							...
							<div class="card bg-transparent">
								<div class="position-relative">
									<!-- Image -->
									<img src="<?= base_url(); ?>/assets/images/instructor/02.jpg" class="card-img" alt="course image">
									<!-- Overlay -->
							...
							<div class="card bg-transparent">
								<div class="position-relative">
									<!-- Image -->
									<img src="<?= base_url(); ?>/assets/images/instructor/01.jpg" class="card-img" alt="course image">
									<!-- Overlay -->
									<div class="card-img-overlay d-flex flex-column p-3">
										<div class="w-100 mt-auto text-end">
											<!-- Card category -->
							...
							<div class="card bg-transparent">
								<div class="position-relative">
									<!-- Image -->
									<img src="<?= base_url(); ?>/assets/images/instructor/08.jpg" class="card-img" alt="course image">
									<!-- Overlay -->
									<div class="card-img-overlay d-flex flex-column p-3">
										<div class="w-100 mt-auto text-end">
											<!-- Card category -->
							...
							<div class="card bg-transparent">
								<div class="position-relative">
									<!-- Image -->
									<img src="<?= base_url(); ?>/assets/images/instructor/04.jpg" class="card-img" alt="course image">
									<!-- Overlay -->
									<div class="card-img-overlay d-flex flex-column p-3">
										<div class="w-100 mt-auto text-end">
											<!-- Card category -->
							...
							<div class="card bg-transparent">
								<div class="position-relative">
									<!-- Image -->
									<img src="<?= base_url(); ?>/assets/images/instructor/03.jpg" class="card-img" alt="course image">
									<!-- Overlay -->
									<div class="card-img-overlay d-flex flex-column p-3">
										<div class="w-100 mt-auto text-end">
											<!-- Card category -->
				...
				<div class="row">
					<div class="col-12 position-relative z-index-1">
						...
						<div class="d-none d-lg-block position-absolute bottom-0 start-0 ms-3 ms-xl-5">
							<img src="<?= base_url(); ?>/assets/images/element/01.png" alt="">
						</div>
						<!-- Pencil and cap SVG -->
						<div class="position-absolute top-0 end-0 mt-n4 me-5">
							<img src="<?= base_url(); ?>/assets/images/client/pencil.svg" alt="">
						</div>
						<div class="position-absolute bottom-0 start-50 mb-n4">
							<img src="<?= base_url(); ?>/assets/images/client/graduated.svg" class="rotate-74" alt="">
						</div>
					...
					<div class="col-12">
						...
						<div class="tiny-slider arrow-round">
							<div class="tiny-slider-inner" data-arrow="false" data-autoplay="true" data-dots="false" data-gutter="80" data-items-xl="6" data-items-lg="5" data-items-md="4" data-items-sm="3" data-items-xs="2">
								<!-- Slide item START -->
								<div class="item"> <img src="<?= base_url(); ?>/assets/images/client/coca-cola.svg" alt=""> </div>
								<div class="item"> <img src="<?= base_url(); ?>/assets/images/client/android.svg" alt=""> </div>
								<div class="item"> <img src="<?= base_url(); ?>/assets/images/client/envato.svg" alt=""> </div>
								<div class="item"> <img src="<?= base_url(); ?>/assets/images/client/microsoft.svg" alt=""> </div>
								<div class="item"> <img src="<?= base_url(); ?>/assets/images/client/netflix.svg" alt=""> </div>
								<div class="item"> <img src="<?= base_url(); ?>/assets/images/client/google.svg" alt=""> </div>
								<div class="item"> <img src="<?= base_url(); ?>/assets/images/client/linkedin.svg" alt=""> </div>
								<!-- Slide item END -->
							</div>
						</div>
						<!-- Slider END -->
...
<!-- Mirrored from eduport.webestica.com/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Dec 2021 04:52:35 GMT -->
