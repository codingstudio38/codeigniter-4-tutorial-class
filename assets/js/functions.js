...
var e = {
    ...
    darkMode: function () {
        ...
        var changeThemeToDark = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', 'http://localhost/codeIgniter/new-app/assets/css/style-dark-rtl.css');
          } else {
              style.setAttribute('href', 'http://localhost/vidyut/bootstrap5/assets/css/style-dark.css');
          }
        ...
        var changeThemeToLight = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', 'http://localhost/codeIgniter/new-app/assets/css/style-rtl.css');
          } else {
              style.setAttribute('href', 'http://localhost/codeIgniter/new-app/assets/css/style.css');
          }
